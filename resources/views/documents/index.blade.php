            ...
            <div class="col-12 col-xl-10">
                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                    <div>
                        ...
                        <p class="text-body-secondary mb-0">Manage your markdown notes and drafts.</p>
                    </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-0">
                        @if ($documents->isEmpty())
                            <p class="text-body-secondary m-0 p-4">No documents yet. Create your first markdown file.</p>
                        @else
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="d-inline-flex gap-2">
                                                        ...
                                                        <form method="POST" action="{{ route('documents.destroy', $document) }}" onsubmit="return confirm('Move this document to trash?');">
                                                            @csrf
                                                            @method('DELETE')
